...
import { Ship, Users, Award, Star, MessageCircle, Download } from 'lucide-react';
      ...
      <section className="relative bg-gradient-to-br from-zatara-blue-light to-blue-100 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-6xl font-playfair font-bold text-zatara-navy mb-6">
                Discover Mallorca
      ...
      <section className="py-20 bg-zatara-blue text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" className="bg-transparent border-white text-white hover:bg-white hover:text-zatara-blue">
